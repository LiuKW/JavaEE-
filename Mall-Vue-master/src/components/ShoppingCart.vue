      ...
      <div class="add-info-box">
        <div class="add-info-detail">
          ...
          <div class="add-info-box-row">
            <div class="add-info-img">
              <img :src="newShoppingCart.goodMainimageurl" alt="">
            </div>
            <div class="add-info-intro">
              <p>{{newShoppingCart.goodName}} {{newShoppingCart.goodDescription}}...</p>
              <p class="add-info-intro-detail">价格：￥{{newShoppingCart.goodPrice.toFixed(2)}} / 数量：{{newShoppingCart.count}}</p>
            </div>
          </div>
        </div>
        <div class="car-btn-group">
          ...
          <div class="car-btn-row">
            <router-link :to="{ path: '/goodsDetail', query: { id: newShoppingCart.goodId } }">
