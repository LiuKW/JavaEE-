<template>
  <div>
    <div class="container" style="display: flex; justify-content: center; align-items: center; width: 60%;">
      <img src="../../static/img/logo.png" style="width: 100px; height: 100px; margin-right: 50px;" />
