<template>
  <div class="box">
    <div class="nav">
      ...
      <ul class="detail">
        <li class="first" v-show="!userInfo.userNickname">
        ...
        <li v-show="!!userInfo.userNickname">
          <Dropdown>
            <p class="username-p">
              <Avatar class="person-icon" icon="person" size="small" /> <span class="username">{{userInfo.userNickname}} </span>
            </p>
            <DropdownMenu slot="list">
                <div class="my-page">
              ...
              <div class="shopping-cart-list" v-show="shoppingCart.length > 0">
                <div class="shopping-cart-box" v-for="(item,index) in shoppingCart" :key="index">
                  <div class="shopping-cart-img">
                    <img :src="item.goodMainimageurl">
                  </div>
                  <div class="shopping-cart-info">
                    <div class="shopping-cart-title">
                      <p>{{item.goodName.substring(0, 10)}}...</p>
                    </div>
                    <div class="shopping-cart-detail">
                      <p>
                        描述:
                        <span class="shopping-cart-text">
                          {{item.goodDescription.substring(0, 3)}}...
                        </span>
                        数量:
                        <span class="shopping-cart-text">
                          {{item.count}}
